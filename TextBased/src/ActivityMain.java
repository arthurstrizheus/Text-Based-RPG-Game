...
public class ActivityMain {
    ...
    public static int health = 100, defence = 10, strength = 10, attack = 10,
            healthMax = 100, defenceMax = 10, strengthMax = 10, attackMax = 10,
            expOut, expNeededOut, playerLvl = 1, gold = 500, pots = 4, num,
            cost, potions = 0, randA, randD, randS, potionsUpgrade = 100,
            potionHealth = 10, potionAttack = 1, potionDefence = 2,
            potionStrength = 1, potsDrinkCount, potA, potD, potS,
            skillPoints = 1, daggerC = 50, rustySwordC = 100, hatchetC = 250,
            spearC = 500, runeSwordC = 5000, godSwordC = 15000,
            infinitySwordC = 78000, townLvl, playerLvlCongrats;
    //..........................................................................................................................................................................................................

    public static boolean dagger = false, rSword = false, hatchet = false,
            spear = false, runeSword = false, godSword = false,
            infinitySword = false;
    public static boolean Potion = false, QM = false, QM1 = false, town = false,
            store = false, mainM = false, equip = false, Amara = false,
            introS = false;
    public static String playerName, Town, Equipped = "";
    public static float multExp = 1.2f, expNeeded = 100f, exp = 0f,
            uGrade = 1.2f, uCost = 100;
    ...
    public static EnemyStats EnemyLvl1 = new EnemyStats(5, 5, 5, 100, 1, 50,
            100, 30, 30, ".");//this get changed up a bit in the PreFight method
    public static EnemyStats EnemyLvl5 = new EnemyStats(10, 15, 10, 125, 5, 100,
            125, 50, 50, ".");
    public static EnemyStats EnemyLvl10 = new EnemyStats(15, 20, 15, 150, 10,
            150, 150, 100, 100, ".");
    public static EnemyStats EnemyLvl20 = new EnemyStats(25, 25, 20, 200, 20,
            200, 200, 200, 200, ".");
    public static EnemyStats EnemyLvl30 = new EnemyStats(30, 30, 30, 250, 30,
            250, 250, 300, 300, ".");
    public static EnemyStats EnemyLvl40 = new EnemyStats(35, 40, 35, 350, 40,
            300, 350, 600, 600, ".");
    public static EnemyStats EnemyLvl60 = new EnemyStats(45, 50, 55, 500, 60,
            400, 500, 800, 800, ".");
    public static EnemyStats EnemyLvl90 = new EnemyStats(80, 99, 90, 1000, 90,
            550, 1000, 1500, 1500, ".");

    //..........................................................................................................................................................................................................
    //Over here we declare out weapons level and stats

    public static Weapons WoodenDagger = new Weapons(5, 1, 2, 1, 51,
            "Wooden Dagger");
    public static Weapons RustySword = new Weapons(10, 3, 5, 5, 100,
            "Rusty Sword");
    ...
    public static Weapons RuneScimitar = new Weapons(45, 25, 30, 30, 5000,
            "Rune Scimitar");
    public static Weapons GodSword = new Weapons(70, 50, 55, 50, 15000,
            "GodSword");
    public static Weapons InfinitySword = new Weapons(200, 99, 120, 100, 78000,
            "Infinity Sword");
    ...
    public static void PlayerScreenSet() {
        ...
        System.out
                .println("                   Name:" + playerName + "\nHealth: "
                        + health + "    Exp: " + expOut + "/" + expNeededOut
                        + "    Levvl: " + playerLvl + "    Gold: " + gold); //setting the screen
    ...
    public static void StatsScreen() {
        ...
        System.out.println("    Name: " + playerName + "     Level: "
                + playerLvl + "    Gold: " + gold + "     SkillPoints: "
                + skillPoints); //all this code is just printing to the screen the stats and name of player.
        System.out.println("\nHealth: " + health + "          (h+)");
    ...
    public static void Intro() {
        ...
        Clear(); //clearing the screen
        System.out.println(
                "You wake up in a hospital bed and can't remember anything.\n\n"
                        + playerName
                        + ": \"Nurse were am i?\"\nNurse: \"Your are in " + Town
                        + ", you were found in the Forest. You need to get some rest\"\n"
    ...
    public static void MainMenu() {
        Clear();
        mainM = true;
        System.out.println("Health: " + health + "    Exp: " + expOut + "/"
                + expNeededOut + "    Level: " + playerLvl); //setting the screen
        System.out.println("\n\t\tYour are in " + Town);
        System.out.println(
                "\n\n\n\n1: Continue Fighting\n2: Return to town\n3: Inventory\n4: Stats\n5: Fast Travel");
        ...
        switch (were) {
            ...
            case "119":
                if (gold < potionsUpgrade | gold <= 0) {
                    ...
                    if (potionAttack == 20 & potionDefence == 20
                            & potionStrength == 20) { //if potion all potion stats equal 20 you will no longer be able to but it.
                        System.out.println(
                                "You have reached the max amount of upgrades.");
                    } else {
                        PotionsUpgrade();
    ...
    public static void Inventory() {
        ...
        System.out.println(
                "Type e and the number you would like to equip to equip a weapon\n");
        System.out.println(Equipped);
        Stream<String> stream = Arrays.stream(Inv);
        ...
        switch (were) {
            ...
            case "e1":
                if (equip == true) {
                    Clear();
                    System.out.println(
                            "You already have a item equipped, Would you like to unequip it?");
                ...
                if (dagger == true) {
                    equip = true;
                    Equipped = "Equipped: Wooden Dagger";
            ...
            case "e5":
                ...
                if (runeSword == true) {
                    equip = true;
                    Equipped = "Equipped: Rune Scimitar";
            ...
            case "e7":
                ...
                if (infinitySword == true) {
                    equip = true;
                    Equipped = "Equipped: Infinity Sword";
    ...
    public static void Quartermaster() {
        ...
        if (Amara == true & QM == true) {//this was added just so players can fight a boss, like the dragon good i want there to be an extra dialog. (IN case 2)
            Clear();
            QM1 = true; //making this boolean true so that if the payer goes to stats screen they can not go anywhere else but back, And so if they do go back so they fot back to the right place.
            System.out.println("Quartermaster: \"Welcome back " + playerName
            ...
            switch (DragonFight) {
                ...
                case "2":
                    Clear();
                    System.out.println(
                            "Quartermaster: Are You sure you want to fight the Dragon God!? He is a very tough opponent");
                    System.out.println(
    ...
    public static void FightScreen() {
        ...
        if (Potion == true) { //Okay you might be like "Why did he do this.." well it is to make the game look a bit better. this so it shows that fancy (+1) next to attack when the player has drank a potion
            ...
            System.out.println(
                    "  " + playerName + "     \tVS   \t" + EnemyIG.Name); //here we are printing out out fight screen, were we show both the player and enemy stats
            System.out.println("\nHealth:      " + health + "     \t"
                    + EnemyIG.hp + "/" + EnemyIG.hpMax);
            System.out.println("Attack:      " + attack + " (+" + potA + ")"
                    + "     \t" + EnemyIG.attack);
            System.out.println("Defence:     " + defence + " (+" + potD + ")"
                    + "     \t" + EnemyIG.defence); //we use the potA variable because we cant use the attack/attackMax the numbers are not true. what i mean by this
            System.out.println("Strength:    " + strength + " (+" + potS + ")"
                    + "     \t" + EnemyIG.strength); //is that if we do use the attack or attack max in here then it will not show the actual pot bonus it will show
        ...
        System.out.println("\nHealth:      " + health + "     \t" + EnemyIG.hp
                + "/" + EnemyIG.hpMax);
        System.out.println(
                "Attack:      " + attack + "         \t" + EnemyIG.attack);
        System.out.println(
                "Defence:     " + defence + "         \t" + EnemyIG.defence);
        System.out.println(
                "Strength:    " + strength + "         \t" + EnemyIG.strength);
        System.out.println("Potions:     " + pots);
        System.out.println("\n\n1: Attack\n2:Drink Potion\n3:Run");
        Attack();//running the Attack method.. all it does is check what the player typed in (1,2,3) and run that code for what they entered
    ...
    public static void EnemyDeathScreen() {
        ...
        System.out.println("\n              Great job you have killed a Level "
                + EnemyIG.Lvl + " " + EnemyIG.Name);
    ...
    public static void Attack() {
        ...
        switch (dowhat) {
            ...
            case "1":
                ...
                try {
                    int enemyDamage = EnemyIG.attack + EnemyIG.defence
                            + EnemyIG.strength, enemyRand; //this is the enemy damage to player same as all the other attack is setup
                    ...
                    System.out.println("The " + EnemyIG.Name + " hit you with "
                            + enemyRand + " damage"); //just another delay
            ...
            case "2":
                if (pots <= 0) {
                    ...
                    try {
                        System.out.println(
                                "You have gained the max number of stats bonus from potions!"); //just another delay
                        Thread.sleep(800); //delay of 800 milliseconds
                        PotionsDrink();
                        FightScreen();
                    } catch (InterruptedException e) {
            ...
            case "3": //this is the runaway calculations
                int eRun = EnemyIG.attack + EnemyIG.strength + EnemyIG.defence,
                        pRun = attack + defence + strength, runChance,
                        runDamage;
                eRun = eRun / 3;
                pRun = pRun / 3;
                runChance = rand.nextInt(0 + pRun) + 1;
                runDamage = rand.nextInt(0 + eRun);
                if (runChance == eRun | runChance == eRun + 1
                        | runChance == eRun - 1 | runChance == eRun + 3
                        | runChance == eRun - 4) { // i did this because i want players to have a bigger change for getting away
                    try {
                    ...
                    try {
                        System.out.println(
                                "You have failed to ran away! You get hit with "
                                        + runDamage + " damage"); //printing this to screen
                        if (health <= 0) {
                            YourDead();
                        }
                        Thread.sleep(1200); //delay of 800 milliseconds
    ...
    public static void Hospital() {
        PlayerScreenSet();
        System.out.println("\n\nHi Welcome to " + Town
                + " towns hospital, what can i do for you?");
        System.out.println("\n\n1: Heal me\n2: Leave hospital");
        String doWhat = in.nextLine();
        switch (doWhat) {
            case "1":
